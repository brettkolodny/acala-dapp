...
import { useMemState, useLPCurrencies, useLPEnabledCurrencies, useEnableLPs } from '@acala-dapp/react-hooks';
...
export const IncentivesProvider: FC<BareProps> = ({ children }) => {
  const [activeTabs, setActiveTabs] = useMemState<ActiveTabs>('honzon-incentives');
